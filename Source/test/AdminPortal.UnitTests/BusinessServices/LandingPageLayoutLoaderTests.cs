    ...
    public class LandingPageLayoutLoaderTests
    {
        ...
        public void GetUiLinks_2TabsExample_MatchExpected()
        {
           // DebugEnvironmentSettings.DebugApplicationFolderPath();
            ...
            LandingPageLayoutLoader landingPage = new LandingPageLayoutLoader(null,file, _logger);
        ...
        public void GetRegionIndicators_RegionIndicatorListObject()
        {
            ...
            LandingPageLayoutLoader landingPage = new LandingPageLayoutLoader(null,landingPageLayoutFile, _logger, regionsfile);
        ...
        public void GetUiLinks_NullFilePath_LandingPageTabs()
        {
            ...
            //config["LandingPageLayoutRelativePath"].ReturnsForAnyArgs("Config\\LandingPageLayout.Local.xml");
           

            LandingPageLayoutLoader landingPage = new LandingPageLayoutLoader(config, null, _logger);
        ...
        {
            //Arrange
            LandingPageLayoutLoader landingPage = new LandingPageLayoutLoader(null,_filepath, _logger);
